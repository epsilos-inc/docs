---
title: Changelog
description: Notable customer-facing changes to the Epsilos platform.
sidebar:
  order: 1
---
...
- Theme and add-on marketplace
- AI design editor and AI customer assistant
- Native mobile app (add-on) with push notifications
- Visitor analytics
