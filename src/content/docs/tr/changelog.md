...
description: Epsilos platformundaki kayda değer, müşteriye yönelik değişiklikler.
sidebar:
  order: 1
---
...
- Tema ve eklenti pazarı
- AI tasarım editörü ve AI müşteri asistanı
- Push bildirimli native mobil uygulama (eklenti)
- Ziyaretçi analitiği
- Rich snippet / yapılandırılmış veri işaretlemesi
